...
class RegistriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create registry" do
    assert_difference('Registry.count') do
      post registries_url, params: { registry: { location: @registry.location, name: @registry.name } }
    end
  ...
  test "should update registry" do
    patch registry_url(@registry), params: { registry: { location: @registry.location, name: @registry.name } }
