...
class CoordinatorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coordinator" do
    assert_difference('Coordinator.count') do
      post coordinators_url, params: { coordinator: { email: @coordinator.email, name: @coordinator.name, phone_number: @coordinator.phone_number, string: @coordinator.string } }
    end
  ...
  test "should update coordinator" do
    patch coordinator_url(@coordinator), params: { coordinator: { email: @coordinator.email, name: @coordinator.name, phone_number: @coordinator.phone_number, string: @coordinator.string } }
