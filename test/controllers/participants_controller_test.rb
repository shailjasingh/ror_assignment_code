...
class ParticipantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create participant" do
    assert_difference('Participant.count') do
      post participants_url, params: { participant: { dob: @participant.dob, gender: @participant.gender, name: @participant.name } }
    end
  ...
  test "should update participant" do
    patch participant_url(@participant), params: { participant: { dob: @participant.dob, gender: @participant.gender, name: @participant.name } }
